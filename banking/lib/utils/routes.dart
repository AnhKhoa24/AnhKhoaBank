import 'package:banking/pages/dashboard/dashboard_page.dart';
import 'package:banking/services/testapi_widget.dart';
import 'package:flutter/material.dart';
import '/pages/auth/login/login_face_unlock_page.dart';
import '/pages/auth/login/pin_code_page.dart';
import '/pages/auth/register/register_fingerprint_unlock_page.dart';
import '/pages/auth/register/register_page.dart';
import '/pages/card/add_card_page.dart';
import '/pages/dashboard/add_new_account/add_new_account_page.dart';
import '/pages/dashboard/saving/add_saving_page.dart';
...
class RouteGenerator {
  ...
  static const String testApiPage = 'testApiPage';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      case testApiPage:
        return MaterialPageRoute(builder: (_) => const TestApiPage());
      case loginPage:
